...
import { refreshToken as refreshAuthToken, logout as logoutUser, getUserInfo as fetchUserInfo } from '../services/auth-service';
...
export const useAuth = () => {
  ...
  if (context === undefined) {
    ...
    console.error('Current component tree:', typeof window !== 'undefined' ? window.location.pathname : 'Server-side');
