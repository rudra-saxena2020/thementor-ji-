...
export const mockTasks: Task[] = [
  { id: '1', title: 'Complete Physics Chapter 3 Exercises', completed: false, dueDate: 'Today', type: 'task', subject: 'Physics' },
  { id: '2', title: 'Review Calculus Formulas', completed: true, dueDate: 'Today', type: 'task', subject: 'Math' },
  { id: '3', title: 'Weekly Goal: Finish Organic Chemistry', completed: false, dueDate: 'Friday', type: 'goal', subject: 'Chemistry' },
];