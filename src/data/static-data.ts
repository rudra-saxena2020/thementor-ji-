...
export const studyTemplates: Record<string, Partial<Task>[]> = {
  "7-day": [
    { title: "Day 1: Physics Mechanics Review", type: "task", subject: "Physics" },
    { title: "Day 2: Chemistry Atomic Structure", type: "task", subject: "Chemistry" },
    { title: "Day 3: Math Calculus Basics", type: "task", subject: "Math" },
    { title: "Day 4: Physics Thermodynamics", type: "task", subject: "Physics" },
    { title: "Day 5: Chemistry Bonding", type: "task", subject: "Chemistry" },
    { title: "Day 6: Math Algebra Practice", type: "task", subject: "Math" },
    { title: "Day 7: Full Week Revision", type: "goal", subject: "General" },
  ],
  "15-day": [
    { title: "Day 1-3: Physics Intensive", type: "goal", subject: "Physics" },
    { title: "Day 4-6: Chemistry Organic", type: "goal", subject: "Chemistry" },
    { title: "Day 7: Mock Test 1", type: "task", subject: "General" },
    { title: "Day 8-10: Math Calculus Deep Dive", type: "goal", subject: "Math" },
    { title: "Day 11-13: Previous Year Questions", type: "task", subject: "General" },
    { title: "Day 14: Formula Revision", type: "task", subject: "General" },
    { title: "Day 15: Final Mock Test", type: "goal", subject: "General" },
  ]
};
